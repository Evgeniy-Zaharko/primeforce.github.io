...
$("#submit_btn").click(function() {
   ...
   if ($("#typewriting").length) {
      ...
      typewriter.typeString('Поддержка сети TON').pauseFor(1500).deleteAll()
         .typeString('Надежное партнерство').pauseFor(1500).deleteAll()
         .typeString('Опытная команда').start();
   }
